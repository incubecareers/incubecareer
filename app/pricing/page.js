        ...
        <div className="mt-6 overflow-hidden rounded-[2rem] border border-brand-border bg-white shadow-card">
          ...
          <div className="p-8 lg:p-12">
            ...
            <div className="mt-10 rounded-3xl border border-brand-border bg-brand-surface p-8">
              ...
              <Link href="mailto:incubecareers@gmail.com" className="mt-6 inline-flex items-center rounded-full bg-brand-secondary px-4 py-3 text-sm font-semibold text-white transition hover:bg-brand-secondaryDark">
                Get in touch
              </Link>
            </div>
          </div>
