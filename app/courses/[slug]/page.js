      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          {course.whatYouLearn?.length > 0 && (
            <section className="mt-8 rounded-2xl border border-brand-border bg-brand-dark-card p-6 shadow-card">
          ...
          <section className="mt-8">
            ...
            <div className="mt-4 space-y-3">
              {sectionsWithLessons.map((s) => (
                <div
                  key={s._id}
                  className="overflow-hidden rounded-2xl border border-brand-border bg-brand-dark-card shadow-card"
                >
            ...
            <section className="mt-8">
              ...
              <ul className="mt-3 space-y-2">
                {quizzes.map((q) => (
                  <li
                    key={q._id}
                    className="flex items-center gap-2 rounded-xl border border-brand-border bg-brand-dark-card px-4 py-3 text-sm text-brand-textPrimary shadow-card"
                  >
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-24 overflow-hidden rounded-2xl border border-brand-border bg-brand-dark-card shadow-cardHover">
